...
//=========  (Fri Mar  3 20:13:38 2023) by ROOT version 6.24/00
   TCanvas *c1_n1 = new TCanvas("c1_n1", "c1",0,0,800,602);
   gStyle->SetOptStat(0);
   c1_n1->SetHighLightColor(2);
   c1_n1->Range(1.636347e+09,1.237018,1.682116e+09,1.335104);
   ...
   TH2D *throwsPawaysPhisto__9 = new TH2D("throwsPawaysPhisto__9","",1,1.64367e+09,1.677539e+09,1,1.252712,1.330199);
   ...
   throwsPawaysPhisto__9->GetXaxis()->SetTimeFormat("#splitline{%b}{%Y} %F1970-01-01 00:00:00");
   throwsPawaysPhisto__9->GetXaxis()->SetRange(1,1);
   throwsPawaysPhisto__9->GetXaxis()->SetNdivisions(100506);
   ...
   TH2D *throwsPawaysPhisto_copy__10 = new TH2D("throwsPawaysPhisto_copy__10","",1,1.64367e+09,1.677539e+09,1,1.252712,1.330199);
   ...
   throwsPawaysPhisto_copy__10->GetXaxis()->SetTimeFormat("#splitline{%b}{%Y} %F1970-01-01 00:00:00");
   throwsPawaysPhisto_copy__10->GetXaxis()->SetRange(1,1);
   throwsPawaysPhisto_copy__10->GetXaxis()->SetNdivisions(100506);
