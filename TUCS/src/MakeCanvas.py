...
#    ROOT.gStyle.SetHistFillStyle(3001)
    ...
    ROOT.gStyle.SetTitleOffset(1., "y") #1.46

    ROOT.gStyle.SetPaperSize(20,26)
    ROOT.gStyle.SetPadTopMargin(0.05)
    ROOT.gStyle.SetPadRightMargin(0.1) #0.05
...
#    ROOT.gROOT.ForceStyle()
    ...
    c1 = ROOT.TCanvas("c1_n%d" % canvas_number, "c1",0,44,ww,wh)
...
def myText(x, y, color, text, size=0.05, angle=0.0):
    # tsize=0.05
