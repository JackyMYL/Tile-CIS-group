...
class WriteChanNoiseDB(ReadGenericCalibration):
    '''
    Writes channel noise constants to sqlite file.
    '''

    def __init__(self, runType = 'PedUpdate',offline_iov = 'use latest run',dbConn='CONDBR2', sqlfn='tileSqlite.db'):
        ...
        self.online_folder = {}
        self.online_tag = {}
        self.offline_tag['efit']    = 'TileOfl02NoiseFit-RUN2-HLT-UPD1-01'
        ...
        self.offline_tag['of1']    = 'TileOfl02NoiseOf1-RUN2-HLT-UPD1-01'
        ...
        self.offline_tag['of2']    = 'TileOfl02NoiseOf2-RUN2-HLT-UPD1-01'
    ...
    def ProcessStart(self):
        ...
        for key in list(self.offline_tag.keys()):
    ...
    def ProcessRegion(self, region):
        ...
        for event in region.GetEvents():
            if event.run.runType == self.runType:
                for key in list(self.DBdict.keys()):
                    try:
