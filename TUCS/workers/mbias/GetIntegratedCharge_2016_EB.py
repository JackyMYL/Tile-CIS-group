...
class GetIntegratedCharge_2016_EB(GenericWorker):
...
#        regionsAll = ['C10', 'B11', 'B12', 'B13', 'B14', 'B15']
        regionsAll = ['E3', 'E4']
#        regionsAll = ['E1', 'E2','E3','E4']
#        regionsAll = ['A1', 'A2', 'A3', 'A4', 'A5', 'A6', 'A7', 'A8', 'A9', 'A10']
        ...
        with open('Laser_A13Ecells_variation_2016_25oct.txt') as f:
            ...
            for line in data:
                ...
                for i in range(len(LaserInformation)):
                    ...
                    if laserinfo[0]==LaserInformation[i][0] and laserinfo[3]==LaserInformation[i][3] and ( ( "A" in laserinfo[2] and "A" in LaserInformation[i][2]) or ( "C" in laserinfo[2] and  "C" in LaserInformation[i][2])) :# channe#ldoesn't need to be the same of course:
                        LaserInformationCorr.append([laserinfo[0],float(laserinfo[1])-D5dev, laserinfo[2], laserinfo[3], laserinfo[4]])
#                        channel=self.PMTool.get_PMT_index(partDict[laserinfo[2]],int(laserinfo[3])-1, int(laserinfo[4]))
#                        LaserInformationCorr.append([float(laserinfo[0]),float(laserinfo[1])-D5dev, laserinfo[2]+"_m01_ch"+str(channel), int(laserinfo[3])]) #for Laser only
                        break # match found
...
#        f.open('Mbias_variation_2015.txt','r')
        ...
        with open('Mbias_NewEcells_variation_2015_24oct16_refD6.txt') as f: 
            data = f.readlines()
            for line in data:
...
#                        if channel==13 and ( ExtendedBarrel[i][1]==28 or  ExtendedBarrel[i][1]==31 or ExtendedBarrel[i][1]==33 or ExtendedBarrel[i][1]==36):
#                            continue # now only E' cells
...
#                            f.close()
        ...
        tmp_Datime = TDatime(tmp_Datime_str)
        intLUMI.SetPoint(intLUMI.GetN(), (tmp_Datime).Convert()-1.0+75186.6, intL)
        intL +=509.444
        intLUMI.SetPoint(intLUMI.GetN(), (tmp_Datime).Convert()+75186.6, intL)
        tmp_Datime_str = "2016-08-30 23:44:00"
        tmp_Datime = TDatime(tmp_Datime_str)
        intLUMI.SetPoint(intLUMI.GetN(), (tmp_Datime).Convert()-1.0+24100.4, intL)
        intL +=217.645
        intLUMI.SetPoint(intLUMI.GetN(), (tmp_Datime).Convert()+24100.4, intL)
        tmp_Datime_str = "2016-08-31 08:30:00"
        tmp_Datime = TDatime(tmp_Datime_str)
        intLUMI.SetPoint(intLUMI.GetN(), (tmp_Datime).Convert()-1.0+7977, intL)
        intL +=80.635
        intLUMI.SetPoint(intLUMI.GetN(), (tmp_Datime).Convert()+7977, intL)
        tmp_Datime_str = "2016-08-31 14:45:00"
        tmp_Datime = TDatime(tmp_Datime_str)
        intLUMI.SetPoint(intLUMI.GetN(), (tmp_Datime).Convert()-1.0+48000.3, intL)
        intL +=362.217
        intLUMI.SetPoint(intLUMI.GetN(), (tmp_Datime).Convert()+48000.3, intL)
        tmp_Datime_str = "2016-09-01 08:08:00"
        tmp_Datime = TDatime(tmp_Datime_str)
        intLUMI.SetPoint(intLUMI.GetN(), (tmp_Datime).Convert()-1.0+38820.5, intL)
        intL +=325.616
        intLUMI.SetPoint(intLUMI.GetN(), (tmp_Datime).Convert()+38820.5, intL)
        tmp_Datime_str = "2016-09-01 23:37:00"
        tmp_Datime = TDatime(tmp_Datime_str)
        intLUMI.SetPoint(intLUMI.GetN(), (tmp_Datime).Convert()-1.0+7576.5, intL)
        intL +=72.511
        intLUMI.SetPoint(intLUMI.GetN(), (tmp_Datime).Convert()+7576.5, intL)
        tmp_Datime_str = "2016-09-02 10:52:00"
        tmp_Datime = TDatime(tmp_Datime_str)
        intLUMI.SetPoint(intLUMI.GetN(), (tmp_Datime).Convert()-1.0+69067.1, intL)
        intL +=466.74
        intLUMI.SetPoint(intLUMI.GetN(), (tmp_Datime).Convert()+69067.1, intL)
        tmp_Datime_str = "2016-09-03 10:22:00"
        tmp_Datime = TDatime(tmp_Datime_str)
        intLUMI.SetPoint(intLUMI.GetN(), (tmp_Datime).Convert()-1.0+8911.6, intL)
        intL +=90.678
        intLUMI.SetPoint(intLUMI.GetN(), (tmp_Datime).Convert()+8911.6, intL)
        tmp_Datime_str = "2016-09-03 15:16:00"
        tmp_Datime = TDatime(tmp_Datime_str)
        intLUMI.SetPoint(intLUMI.GetN(), (tmp_Datime).Convert()-1.0+25065.1, intL)
        intL +=235.563
        intLUMI.SetPoint(intLUMI.GetN(), (tmp_Datime).Convert()+25065.1, intL)
        tmp_Datime_str = "2016-09-04 01:05:00"
        tmp_Datime = TDatime(tmp_Datime_str)
        intLUMI.SetPoint(intLUMI.GetN(), (tmp_Datime).Convert()-1.0+87238.4, intL)
        intL +=572.471
        intLUMI.SetPoint(intLUMI.GetN(), (tmp_Datime).Convert()+87238.4, intL)
        tmp_Datime_str = "2016-09-05 19:31:00"
        tmp_Datime = TDatime(tmp_Datime_str)
        intLUMI.SetPoint(intLUMI.GetN(), (tmp_Datime).Convert()-1.0+38863.2, intL)
        intL +=317.83
        intLUMI.SetPoint(intLUMI.GetN(), (tmp_Datime).Convert()+38863.2, intL)
        tmp_Datime_str = "2016-09-06 14:39:00"
        tmp_Datime = TDatime(tmp_Datime_str)
        intLUMI.SetPoint(intLUMI.GetN(), (tmp_Datime).Convert()-1.0+59346.8, intL)
        intL +=441.473
        intLUMI.SetPoint(intLUMI.GetN(), (tmp_Datime).Convert()+59346.8, intL)
        tmp_Datime_str = "2016-09-08 07:44:00"
        tmp_Datime = TDatime(tmp_Datime_str)
        intLUMI.SetPoint(intLUMI.GetN(), (tmp_Datime).Convert()-1.0+77968.3, intL)
        intL +=506.281
        intLUMI.SetPoint(intLUMI.GetN(), (tmp_Datime).Convert()+77968.3, intL)
        tmp_Datime_str = "2016-09-09 10:01:00"
        tmp_Datime = TDatime(tmp_Datime_str)
        intLUMI.SetPoint(intLUMI.GetN(), (tmp_Datime).Convert()-1.0+49155.1, intL)
        intL +=372.048
        intLUMI.SetPoint(intLUMI.GetN(), (tmp_Datime).Convert()+49155.1, intL)
        tmp_Datime_str = "2016-09-25 06:36:00"
        tmp_Datime = TDatime(tmp_Datime_str)
        intLUMI.SetPoint(intLUMI.GetN(), (tmp_Datime).Convert()-1.0+18962.8, intL)
        intL +=6.104
        intLUMI.SetPoint(intLUMI.GetN(), (tmp_Datime).Convert()+18962.8, intL)
        tmp_Datime_str = "2016-09-25 14:33:00"
        tmp_Datime = TDatime(tmp_Datime_str)
        intLUMI.SetPoint(intLUMI.GetN(), (tmp_Datime).Convert()-1.0+8519.7, intL)
        intL +=7.701
        intLUMI.SetPoint(intLUMI.GetN(), (tmp_Datime).Convert()+8519.7, intL)
        tmp_Datime_str = "2016-09-26 07:53:00"
        tmp_Datime = TDatime(tmp_Datime_str)
        intLUMI.SetPoint(intLUMI.GetN(), (tmp_Datime).Convert()-1.0+14830, intL)
        intL +=79.747
        intLUMI.SetPoint(intLUMI.GetN(), (tmp_Datime).Convert()+14830, intL)
        tmp_Datime_str = "2016-09-26 15:00:00"
        tmp_Datime = TDatime(tmp_Datime_str)
        intLUMI.SetPoint(intLUMI.GetN(), (tmp_Datime).Convert()-1.0+59452.9, intL)
        intL +=472.63
        intLUMI.SetPoint(intLUMI.GetN(), (tmp_Datime).Convert()+59452.9, intL)
        tmp_Datime_str = "2016-09-27 10:37:00"
        tmp_Datime = TDatime(tmp_Datime_str)
        intLUMI.SetPoint(intLUMI.GetN(), (tmp_Datime).Convert()-1.0+67754.9, intL)
        intL +=481.448
        intLUMI.SetPoint(intLUMI.GetN(), (tmp_Datime).Convert()+67754.9, intL)
        tmp_Datime_str = "2016-09-28 11:38:00"
        tmp_Datime = TDatime(tmp_Datime_str)
        intLUMI.SetPoint(intLUMI.GetN(), (tmp_Datime).Convert()-1.0+47937.5, intL)
        intL +=395.565
        intLUMI.SetPoint(intLUMI.GetN(), (tmp_Datime).Convert()+47937.5, intL)
        tmp_Datime_str = "2016-09-30 02:54:00"
        tmp_Datime = TDatime(tmp_Datime_str)
        intLUMI.SetPoint(intLUMI.GetN(), (tmp_Datime).Convert()-1.0+56077.6, intL)
        intL +=406.429
        intLUMI.SetPoint(intLUMI.GetN(), (tmp_Datime).Convert()+56077.6, intL)
        tmp_Datime_str = "2016-09-30 21:02:00"
        tmp_Datime = TDatime(tmp_Datime_str)
        intLUMI.SetPoint(intLUMI.GetN(), (tmp_Datime).Convert()-1.0+46831.3, intL)
        intL +=370.881
        intLUMI.SetPoint(intLUMI.GetN(), (tmp_Datime).Convert()+46831.3, intL)
        tmp_Datime_str = "2016-10-02 13:14:00"
        tmp_Datime = TDatime(tmp_Datime_str)
        intLUMI.SetPoint(intLUMI.GetN(), (tmp_Datime).Convert()-1.0+51337.6, intL)
        intL +=396.377
        intLUMI.SetPoint(intLUMI.GetN(), (tmp_Datime).Convert()+51337.6, intL)
        tmp_Datime_str = "2016-10-06 10:49:00"
        tmp_Datime = TDatime(tmp_Datime_str)
        intLUMI.SetPoint(intLUMI.GetN(), (tmp_Datime).Convert()-1.0+2674.1, intL)
        intL +=24.234
        intLUMI.SetPoint(intLUMI.GetN(), (tmp_Datime).Convert()+2674.1, intL)
        tmp_Datime_str = "2016-10-08 10:10:00"
        tmp_Datime = TDatime(tmp_Datime_str)
        intLUMI.SetPoint(intLUMI.GetN(), (tmp_Datime).Convert()-1.0+4087.4, intL)
        intL +=0.16
        intLUMI.SetPoint(intLUMI.GetN(), (tmp_Datime).Convert()+4087.4, intL)
        tmp_Datime_str = "2016-10-08 17:08:00"
        tmp_Datime = TDatime(tmp_Datime_str)
        intLUMI.SetPoint(intLUMI.GetN(), (tmp_Datime).Convert()-1.0+23990.6, intL)
        intL +=8.522
        intLUMI.SetPoint(intLUMI.GetN(), (tmp_Datime).Convert()+23990.6, intL)
        tmp_Datime_str = "2016-10-09 07:37:00"
        tmp_Datime = TDatime(tmp_Datime_str)
        intLUMI.SetPoint(intLUMI.GetN(), (tmp_Datime).Convert()-1.0+3436.1, intL)
        intL +=37.503
        intLUMI.SetPoint(intLUMI.GetN(), (tmp_Datime).Convert()+3436.1, intL)
        tmp_Datime_str = "2016-10-09 12:13:00"
        tmp_Datime = TDatime(tmp_Datime_str)
        intLUMI.SetPoint(intLUMI.GetN(), (tmp_Datime).Convert()-1.0+62787.6, intL)
        intL +=482.167
        intLUMI.SetPoint(intLUMI.GetN(), (tmp_Datime).Convert()+62787.6, intL)
        tmp_Datime_str = "2016-10-10 14:36:00"
        tmp_Datime = TDatime(tmp_Datime_str)
        intLUMI.SetPoint(intLUMI.GetN(), (tmp_Datime).Convert()-1.0+60330.4, intL)
        intL +=459.897
        intLUMI.SetPoint(intLUMI.GetN(), (tmp_Datime).Convert()+60330.4, intL)
        tmp_Datime_str = "2016-10-11 09:06:00"
        tmp_Datime = TDatime(tmp_Datime_str)
        intLUMI.SetPoint(intLUMI.GetN(), (tmp_Datime).Convert()-1.0+3734.3, intL)
        intL +=44.34
        intLUMI.SetPoint(intLUMI.GetN(), (tmp_Datime).Convert()+3734.3, intL)
        tmp_Datime_str = "2016-10-12 00:34:00"
        tmp_Datime = TDatime(tmp_Datime_str)
        intLUMI.SetPoint(intLUMI.GetN(), (tmp_Datime).Convert()-1.0+22549, intL)
        intL +=206.403
        intLUMI.SetPoint(intLUMI.GetN(), (tmp_Datime).Convert()+22549, intL)
        tmp_Datime_str = "2016-10-12 21:40:00"
        tmp_Datime = TDatime(tmp_Datime_str)
        intLUMI.SetPoint(intLUMI.GetN(), (tmp_Datime).Convert()-1.0+16801.7, intL)
        intL +=169.632
        intLUMI.SetPoint(intLUMI.GetN(), (tmp_Datime).Convert()+16801.7, intL)
        tmp_Datime_str = "2016-10-13 05:33:00"
        tmp_Datime = TDatime(tmp_Datime_str)
        intLUMI.SetPoint(intLUMI.GetN(), (tmp_Datime).Convert()-1.0+25109.5, intL)
        intL +=254.391
        intLUMI.SetPoint(intLUMI.GetN(), (tmp_Datime).Convert()+25109.5, intL)
        tmp_Datime_str = "2016-10-14 08:55:00"
        tmp_Datime = TDatime(tmp_Datime_str)
        intLUMI.SetPoint(intLUMI.GetN(), (tmp_Datime).Convert()-1.0+11616.8, intL)
        intL +=6.528
        intLUMI.SetPoint(intLUMI.GetN(), (tmp_Datime).Convert()+11616.8, intL)
        tmp_Datime_str = "2016-10-14 18:52:00"
        tmp_Datime = TDatime(tmp_Datime_str)
        intLUMI.SetPoint(intLUMI.GetN(), (tmp_Datime).Convert()-1.0+84447.3, intL)
        intL +=589.867
        intLUMI.SetPoint(intLUMI.GetN(), (tmp_Datime).Convert()+84447.3, intL)
        tmp_Datime_str = "2016-10-15 21:42:00"
        tmp_Datime = TDatime(tmp_Datime_str)
        intLUMI.SetPoint(intLUMI.GetN(), (tmp_Datime).Convert()-1.0+41077.4, intL)
        intL +=357.824
        intLUMI.SetPoint(intLUMI.GetN(), (tmp_Datime).Convert()+41077.4, intL)
        tmp_Datime_str = "2016-10-16 20:17:00"
        tmp_Datime = TDatime(tmp_Datime_str)
        intLUMI.SetPoint(intLUMI.GetN(), (tmp_Datime).Convert()-1.0+51230.6, intL)
        intL +=435.06
        intLUMI.SetPoint(intLUMI.GetN(), (tmp_Datime).Convert()+51230.6, intL)
        tmp_Datime_str = "2016-10-17 12:45:00"
        tmp_Datime = TDatime(tmp_Datime_str)
        intLUMI.SetPoint(intLUMI.GetN(), (tmp_Datime).Convert()-1.0+5512.7, intL)
        intL +=0.042
        intLUMI.SetPoint(intLUMI.GetN(), (tmp_Datime).Convert()+5512.7, intL)
        tmp_Datime_str = "2016-10-17 22:43:00"
        tmp_Datime = TDatime(tmp_Datime_str)
        intLUMI.SetPoint(intLUMI.GetN(), (tmp_Datime).Convert()-1.0+63913.9, intL)
        intL +=505.708
        intLUMI.SetPoint(intLUMI.GetN(), (tmp_Datime).Convert()+63913.9, intL)
        tmp_Datime_str = "2016-10-18 18:41:00"
        tmp_Datime = TDatime(tmp_Datime_str)
        intLUMI.SetPoint(intLUMI.GetN(), (tmp_Datime).Convert()-1.0+10765.3, intL)
        intL +=123.747
        intLUMI.SetPoint(intLUMI.GetN(), (tmp_Datime).Convert()+10765.3, intL)
        tmp_Datime_str = "2016-10-19 03:19:00"
        tmp_Datime = TDatime(tmp_Datime_str)
        intLUMI.SetPoint(intLUMI.GetN(), (tmp_Datime).Convert()-1.0+21451.4, intL)
        intL +=217.893
        intLUMI.SetPoint(intLUMI.GetN(), (tmp_Datime).Convert()+21451.4, intL)
        tmp_Datime_str = "2016-10-19 22:26:00"
        tmp_Datime = TDatime(tmp_Datime_str)
        intLUMI.SetPoint(intLUMI.GetN(), (tmp_Datime).Convert()-1.0+29148.6, intL)
        intL +=197.197
        intLUMI.SetPoint(intLUMI.GetN(), (tmp_Datime).Convert()+29148.6, intL)
        tmp_Datime_str = "2016-10-21 01:19:00"
        tmp_Datime = TDatime(tmp_Datime_str)
        intLUMI.SetPoint(intLUMI.GetN(), (tmp_Datime).Convert()-1.0+27206.2, intL)
        intL +=249.062
        intLUMI.SetPoint(intLUMI.GetN(), (tmp_Datime).Convert()+27206.2, intL)
        tmp_Datime_str = "2016-10-21 18:43:00"
        tmp_Datime = TDatime(tmp_Datime_str)
        intLUMI.SetPoint(intLUMI.GetN(), (tmp_Datime).Convert()-1.0+57601.4, intL)
        intL +=407.75
        intLUMI.SetPoint(intLUMI.GetN(), (tmp_Datime).Convert()+57601.4, intL)
        tmp_Datime_str = "2016-10-22 18:00:00"
        tmp_Datime = TDatime(tmp_Datime_str)
        intLUMI.SetPoint(intLUMI.GetN(), (tmp_Datime).Convert()-1.0+28758.5, intL)
        intL +=276.21
        intLUMI.SetPoint(intLUMI.GetN(), (tmp_Datime).Convert()+28758.5, intL)
        tmp_Datime_str = "2016-10-23 03:16:00"
        tmp_Datime = TDatime(tmp_Datime_str)
        intLUMI.SetPoint(intLUMI.GetN(), (tmp_Datime).Convert()-1.0+51642, intL)
        intL +=416.659
        intLUMI.SetPoint(intLUMI.GetN(), (tmp_Datime).Convert()+51642, intL)
        tmp_Datime_str = "2016-10-23 22:47:00"
        tmp_Datime = TDatime(tmp_Datime_str)
        intLUMI.SetPoint(intLUMI.GetN(), (tmp_Datime).Convert()-1.0+50102.2, intL)
        intL +=392.128
        intLUMI.SetPoint(intLUMI.GetN(), (tmp_Datime).Convert()+50102.2, intL)
        tmp_Datime_str = "2016-10-24 18:33:00"
        tmp_Datime = TDatime(tmp_Datime_str)
        intLUMI.SetPoint(intLUMI.GetN(), (tmp_Datime).Convert()-1.0+33973.1, intL)
        intL +=318.506
        intLUMI.SetPoint(intLUMI.GetN(), (tmp_Datime).Convert()+33973.1, intL)
        tmp_Datime_str = "2016-10-25 08:12:00"
        tmp_Datime = TDatime(tmp_Datime_str)
        intLUMI.SetPoint(intLUMI.GetN(), (tmp_Datime).Convert()-1.0+41531.6, intL)
        intL +=361.241
        intLUMI.SetPoint(intLUMI.GetN(), (tmp_Datime).Convert()+41531.6, intL)
        tmp_Datime_str = "2016-10-26 02:20:00"
        tmp_Datime = TDatime(tmp_Datime_str)
        intLUMI.SetPoint(intLUMI.GetN(), (tmp_Datime).Convert()-1.0+13899.9, intL)
        intL +=110.242
        intLUMI.SetPoint(intLUMI.GetN(), (tmp_Datime).Convert()+13899.9, intL)
        tmp_Datime_str = "2016-10-26 07:50:00"
        tmp_Datime = TDatime(tmp_Datime_str)
        intLUMI.SetPoint(intLUMI.GetN(), (tmp_Datime).Convert()-1.0+43500, intL)
        intL +=367.993
        intLUMI.SetPoint(intLUMI.GetN(), (tmp_Datime).Convert()+43500, intL)
        tmp_Datime_str = "2016-10-26 07:50:00"
        tmp_Datime = TDatime(tmp_Datime_str)
        intLUMI.SetPoint(intLUMI.GetN(), (tmp_Datime).Convert()-1.0+43500, intL)
        intL +=367.993
        ...
        for g in range(intLUMI.GetN()):
            ...
            for i in range(len(FullInfo)):
                if FullInfo[i][0]>= x1 and FullInfo[i][0]<x2:
                    ...
                    elif (FullInfo[i][4]==34 and FullInfo[i][2]>0) or (FullInfo[i][4]==59 and FullInfo[i][2]>0) or (FullInfo[i][4]==3 and FullInfo[i][2]<0) or (FullInfo[i][4]==12 and FullInfo[i][2]<0) or (FullInfo[i][4]==19 and FullInfo[i][2]<0) or (FullInfo[i][4]==27 and FullInfo[i][2]<0) or (FullInfo[i][4]==36 and FullInfo[i][2]<0) or (FullInfo[i][4]==48 and FullInfo[i][2]<0) or (FullInfo[i][4]==60 and FullInfo[i][2]<0):
...
#                    if FullInfo[i][2]>=1.2 and FullInfo[i][2]<1.3: #Acells EB
#                        print "A13"
#                    if FullInfo[i][2]>=1.0 and FullInfo[i][2]<1.1: # BC cells EB
#                    if FullInfo[i][2]>=0.0 and FullInfo[i][2]<0.2: # Acells LB
#                        pairsEta11.append([y1*FullInfo[i][3]/1000., FullInfo[i][1]])
#                    if FullInfo[i][2]>=1.3 and FullInfo[i][2]<1.4:
#                    if FullInfo[i][2]>=1.1 and FullInfo[i][2]<1.2:
#                    if FullInfo[i][2]>=0.2 and FullInfo[i][2]<0.4: # Acells LB
...
#                    if FullInfo[i][2]>=0.4 and FullInfo[i][2]<0.6: # Acells LB
#                        pairsEta13.append([y1*FullInfo[i][3]/1000., FullInfo[i][1]])
#                    if FullInfo[i][2]>=1.5 and FullInfo[i][2]<1.7:
#                    if FullInfo[i][2]>=1.3 and FullInfo[i][2]<1.4:
#                    if FullInfo[i][2]>=0.6 and FullInfo[i][2]<0.8: # Acells LB
#                        pairsEta14.append([y1*FullInfo[i][3]/1000., FullInfo[i][1]])
#                    if FullInfo[i][2]>=1.4 and FullInfo[i][2]<1.5:
#                    if FullInfo[i][2]>=1.1 and FullInfo[i][2]<1.2: #A cells EB
#                    if FullInfo[i][2]>=0.8 and FullInfo[i][2]<1.0: # Acells LB
#                        pairsEta15.append([y1*FullInfo[i][3]/1000., FullInfo[i][1]])
#                    if (FullInfo[i][4]==31 and (FullInfo[i][2]>=-0.95 and FullInfo[i][2]<=-0.75)) or (FullInfo[i][4]==44):
#                        pairsSpecial.append([y1*FullInfo[i][3]/1000., FullInfo[i][1]])
...
#        FinalGraphB = TGraph(len(chargeSpec), chargeSpec, variationSpec)
...
#        FinalGraphE1 = TGraph(len(chargeE1), chargeE1, variationE1)
        FinalGraphE1 = TGraph(len(chargeOld), chargeOld, variationOld)
...
#        FinalGraphE2 = TGraph(len(chargeE2), chargeE2, variationE2)
        FinalGraphE2 = TGraph(len(chargeOr), chargeOr, variationOr)
...
#        FinalGraphE3 = TGraph(len(chargeE3), chargeE3, variationE3)
        FinalGraphE3 = TGraph(len(chargeE), chargeE, variationE)
...
#        FinalGraphE4.SetMarkerSize(0.2)
        ...
        FinalGraphE1.Draw("ap")
#        FinalGraphPSM.GetXaxis().SetRangeUser(0,10000.)
        FinalGraphE1.SetMaximum(20.)
        FinalGraphE1.SetMinimum(-20.)
        FinalGraphE2.Draw("samep")
        FinalGraphE3.Draw("samep")
#        FinalGraphE4.Draw("samep")
#        FinalGraphE11.Draw("samep")
        FinalGraphB.Draw("samep")
        FinalGraphE1.GetXaxis().SetTitle("Integrated Charge [mC]")
        FinalGraphE1.GetYaxis().SetTitle("Scintillator Irradiation Effect [%]")

        


        legend = TLegend(0.7,0.7,0.92,0.92)
        legend.SetHeader("E3, E4, EB")
#        legend.AddEntry(FinalHistoE1, "E4' cells","l")
...
#        legend.AddEntry(FinalHistoB, "Special A","l")
#        legend.AddEntry(FinalHistoE11, "E1, EBA, m39","l")
#        legend.AddEntry(FinalHistoB, "E3, EBA, m19","l")


        legend.AddEntry(FinalHistoE1, "irradiated, old","l")
        legend.AddEntry(FinalHistoE2, "Original","l")
        legend.AddEntry(FinalHistoE3, "Eljen","l")
#        legend.AddEntry(FinalHistoE4, "1.3#leq#eta<1.4","l")
        legend.AddEntry(FinalHistoB, "Bicron","l")
        ...
        c.Print("ChargeMBLaser_EcellsMaterialEB2016.root" )
        c.Print("ChargeMBLaser_EcellsMaterialEB2016.png" )
        c.Print("ChargeMBLaser_EcellsMaterialEB2016.C" )
