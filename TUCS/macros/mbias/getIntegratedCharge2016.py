...
# this script calls GetIntegrateCharge_2016 which reads txt files of mbias and laser variations, subtracts the laser from the mbias variation (->irradiation effect) 
...
processors.append(GetIntegratedCharge_2016(LumiBegin=200,LumiRange=30))
