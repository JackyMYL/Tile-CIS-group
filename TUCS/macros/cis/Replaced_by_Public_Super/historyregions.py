...
You have to specify two sets of runs, and this script compares them.  The sets of runs are called 'runs' and 'runs2.  NOTE:  Earlier runs should be 'runs', while more recent runs should be 'runs2'.  This will allow the plot to show the proper decrease in CIS constants over time, rather than showing an increase.'
"""
