...
if mode=='RegularJob':		
	ini_Date = datetime.date.today() - datetime.timedelta(days=35) # ini_date (yesterday's date - 31 days)	
...
#
processors.append( hvPlots(ini_Date, fin_Date, mode, mapping=True, allHisto=True, history=True) )
#processors.append( hvPlots(ini_Date, fin_Date, mode, mapping=False, allHisto=True, history=False) )
